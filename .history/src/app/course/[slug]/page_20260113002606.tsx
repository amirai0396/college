...
import { GraduationCap, Clock, TrendingUp, BookOpen, Briefcase, FileText, Star, MapPin, Phone, Mail } from 'lucide-react';
      ...
      <div className="bg-white shadow-md">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row justify-between gap-6">
            ...
            <Card className="lg:w-80 shrink-0 bg-gradient-to-br from-orange-50 to-orange-100">
              <div className="p-6">
